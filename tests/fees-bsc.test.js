...
// при обороте почти в миллион долларов за сутки и ликвидности $386k.
//
// Пул на Robinhood, из-за которого эта проверка появилась, стоял здесь
// раньше; на BSC его нет, а предмет проверки тот же самый: терминал обязан
// назвать такой пул неплатящим, а не «годным».
const POOL_PAYS_NOTHING =
  '0xa936ad185dd1273b493ea6f8575795a3bba30fba9f97e3768709ee7060c39ed6';
