...
//
// Владелец поставил ширину 50% на USDG/ROBINCAT, померил результат по свечам
...
// Настоящий пул владельца: USDG/ROBINCAT, шаг 300 тиков, стейбл первый.
...
test('обратный перевод возвращает то, что видит владелец', () => {
